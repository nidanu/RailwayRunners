...
def max(num_stations, num_connections, stations, list_connections, min_time):
    ...
    while runs <= total_runs:
        ...
        while n_routes <= min_routes or len(temp_list_connections) != 0: #or score > 8300:
            ...
            previous_score, n_routes, temp_list_connections  = run_random_max(score, min_routes, temp_list_connections, train, stations, visited, driven, cur_station, list_connections, travel_times, n_routes, routes, previous_score, min_expected, max_expected, time_per_route, runs, num_stations, printout, algorithm_name)

...
class Postman():
    ...
    def walking(self, graph: Dict, current_vertex: str, stack: List[str], total_weight: int, circuit: List[str], trajectories: List[Tuple[Any, Any]], max_time: int) -> Tuple[Dict, str, List[str], int, List[str], List[Tuple[Any, Any]]]:
            """
